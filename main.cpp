...
int main(void){
	...
	while(1){//while(canal_3>1300){//probar diferencial
		...
		//PORTA |= (1<<PORTA0);//arm amarillo
		
		//falta parchar esta parte
		//if (giro>=giro_val){
		//giro_control = giro - giro_val;//offset
		//}else{
		//giro_control = giro_val - giro;//offset
		//}
		//esta bugeado en la saturacion
		if (giro>= giro_val){
		giro_control = giro - giro_val;//offset
...
//		giro_control_2 = giro_val - giro;//offset
		
//		accel_control = accel + giro_control;//motor izquierdo
		
//		accel_control_2 = accel + giro_control_2;//motor derecho
		//_------------------------
